...
def main(trials):
    ...
    print("The average number of cells that express both XIST and CD3D across all trials =", np.mean(express_both))
...
if __name__ == '__main__':
    ...
    parser.add_option("-n", type='int', dest="trials", default=15, help='number of simulation trials')
